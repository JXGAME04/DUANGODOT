...
Hệ đạn (`0x080ECAC0` CastMissles, 6 hàm sinh, `missles.txt`, bay, va chạm, sự kiện) đọc ở §13. Chưa đọc (B2c/B3):
`0x08081B70` tìm ô trống, `0x08188BB0` + `0x080821C0` kỹ năng tự động, `0x080E5D90` kinh nghiệm kỹ năng, `0x080E8AE0`
CanCastSkill, `0x08089920`/`0x080B2790` chết của người chơi và PK, bộ nạp `[0x8BADF50]`.
...
Chưa đọc (B2c/B3): `0x080E8770` kỹ năng tạo npc, `0x08188BB0` + `0x080821C0` kỹ năng tự động, `0x08081B70` ô trống khi
đánh lùi, `0x080E5D90` kinh nghiệm kỹ năng, `0x080E8AE0` CanCastSkill, `0x08089920`/`0x080B2790` chết người chơi và PK,
`0x080F2280`/`0x080EF150` chi tiết đi qua các vùng kề của bộ lặp (zone: lưới ô tuyệt đối), `Player+0x5a50`.
