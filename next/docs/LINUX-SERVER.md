...
Chưa đọc (B2b/B3): `0x080ECAC0` CastMissles và 6 hàm sinh đạn (`0x080EB150`, `0x080EB720`, `0x080EBB20`,
`0x080EBF00`, `0x080EC2F0`, `0x080EC690`), bộ đọc `missles.txt`, `0x08076550/0x080760E0/0x080758E0` bay và
va chạm, `0x08081B70` tìm ô trống, `0x08188BB0` + `0x080821C0` kỹ năng tự động, `0x080E5D90` kinh nghiệm
kỹ năng, `0x080E8AE0` CanCastSkill, `0x08089920`/`0x080B2790` chết của người chơi và PK, bộ nạp `[0x8BADF50]`.
