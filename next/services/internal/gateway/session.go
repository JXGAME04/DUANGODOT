...
func (s *session) handle(f frame.Frame) bool {
	...
	case stWorld:
		...
		case jxpb.MsgId_C2G_MOVE, jxpb.MsgId_C2G_CHAT, jxpb.MsgId_C2G_ATTACK,
			jxpb.MsgId_C2G_GIVE_ITEMS, jxpb.MsgId_C2G_SCRIPT_INPUT, jxpb.MsgId_C2G_ITEM_MOVE, jxpb.MsgId_C2G_ITEM_EQUIP, jxpb.MsgId_C2G_ITEM_UNEQUIP, jxpb.MsgId_C2G_ITEM_USE, jxpb.MsgId_C2G_ITEM_DROP,
