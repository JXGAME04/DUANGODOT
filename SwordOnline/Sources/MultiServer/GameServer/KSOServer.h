...
//	int					m_nSaveCount;
	IServer*			m_pServer;
	IServer*			m_pTransServer;//guve
	IServer*			m_pChatServer;
	IServer*			m_pTongServer;
	...
	unsigned int		m_TransSVID;//guve
	unsigned int		m_ChatSVID;
	unsigned int		m_TongSVID;
public:
	KSwordOnLineSever();
	~KSwordOnLineSever();
	BOOL				Init();
	...
	void				Release();
	void				SetServerTrans(unsigned int lnID);//guve
	void				SetServerChat(unsigned int lnID);
	void				SetServerTong(unsigned int lnID);
private:
	void				MessageLoop();
