...
void CS3RobotDlg::InitFuntionEntry()
{
	...
	ProcessArray[s2c_syncend] = SyncEnd;
	ProcessArray[s2c_synccurplayer] = SyncCurPlayerInfo;
	ProcessArray[s2c_synccurplayernormal] = SyncCurPlayerNormalInfo;
	ProcessArray[s2c_playersendchat] = GetPlayerChar;
	ProcessArray[s2c_syncnpc] = SyncNpc;
	ProcessArray[s2c_syncnpcmin] = SyncNpcNormal;
	ProcessArray[s2c_synccurplayerskill] = SyncCurPlayerSkill;
}
