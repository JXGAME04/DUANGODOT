...
KUiOptions::KUiOptions()
{
	...
	m_ToggleItemList[OPTION_I_EXPAND].bInvalid = false;
}
...
void KUiOptions::ToggleOption(int nIndex)
{
	...
	m_ToggleBtn[nIndex].SetLabelColor(bEnable ? m_uEnableTextColor : m_uDisableTextColor);
	switch(nIndex)
	{
...
void KUiOptions::PaintOverChild()
{
