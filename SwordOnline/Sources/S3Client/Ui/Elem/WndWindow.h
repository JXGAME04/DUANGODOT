...
#define	WND_S_WINDOW_ALIGN_R_EDGE	0x00080000
#define	WND_S_WINDOW_ALIGN_B_EDGE	0x00040000
#define	WND_S_WINDOW_ALIGN_CENTERW	0x00020000
#define	WND_S_WINDOW_ALIGN_CENTERH	0x00010000
...
//	void			SetStyle(DWORD	dwStyle);				//修改窗口风格
	...
	virtual void	PaintOverChild() {};
	virtual void	AutoWndAlign();
	void			InitWndAlign(int nStyle);
protected:
