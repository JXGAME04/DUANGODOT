...
#endif
//#define SWORDONLINE_SHOW_DBUG_INFO
...
void UiPaint(int nGameLoop)
{
	...
	if (g_nShowDebugInfo)
	{
		...
		sprintf(Info,"GAME FPS=%d", nGameLoop);
		g_pRepresentShell->OutputText(14, Info, -1, 10, 20, 0xffffffff, 0);
...
bool UiCloseWndsInGame(bool bAll)
{
	...
	KUiTongManager::CloseWindow(bAll);//guve
...
void Player_Faction::OnButtonClick()//guve
{
