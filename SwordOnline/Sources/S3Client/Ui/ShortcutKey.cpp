...
int Mouse_Menu(Lua_State * L)
{
	...
	KUiPlayerItem SelectPlayer;
	int nKind = -1;
	if (!(g_pCoreShell->FindSelectNPC(KShortcutKeyCentre::ms_MouseX, KShortcutKeyCentre::ms_MouseY, relation_none | relation_ally | relation_enemy | relation_dialog, false, &SelectPlayer, nKind)
		 && (kind_player == nKind || kind_normal == nKind || kind_dialoger == nKind )))
		return 0;
	
	PopUpContextPeopleMenu(SelectPlayer, KShortcutKeyCentre::ms_MouseX, KShortcutKeyCentre::ms_MouseY, nKind);
