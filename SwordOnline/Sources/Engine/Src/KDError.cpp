...
ENGINE_API void g_DIError(int nErrorCode)
{
	static ERRORS Errors[] = {
		...
		{ (int)DIERR_DEVICEFULL, "DIERR_DEVICEFULL" },
		{ DIERR_DEVICENOTREG, "DIERR_DEVICENOTREG" },
		{ (int)DIERR_EFFECTPLAYING, "DIERR_EFFECTPLAYING" },
		{ (int)DIERR_HASEFFECTS, "DIERR_HASEFFECTS" },
		{ DIERR_GENERIC, "DIERR_GENERIC" },
		{ DIERR_HANDLEEXISTS, "DIERR_HANDLEEXISTS" },
		{ (int)DIERR_INCOMPLETEEFFECT, "DIERR_INCOMPLETEEFFECT" },
		{ DIERR_INPUTLOST, "DIERR_INPUTLOST" },
		{ DIERR_INVALIDPARAM, "DIERR_INVALIDPARAM" },
		{ (int)DIERR_MOREDATA, "DIERR_MOREDATA" },
		{ DIERR_NOAGGREGATION, "DIERR_NOAGGREGATION" },
		{ DIERR_NOINTERFACE, "DIERR_NOINTERFACE" },
		{ DIERR_NOTACQUIRED, "DIERR_NOTACQUIRED" },
		{ (int)DIERR_NOTBUFFERED, "DIERR_NOTBUFFERED" },
		{ (int)DIERR_NOTDOWNLOADED, "DIERR_NOTDOWNLOADED" },
		{ (int)DIERR_NOTEXCLUSIVEACQUIRED, "DIERR_NOTEXCLUSIVEACQUIRED" },
