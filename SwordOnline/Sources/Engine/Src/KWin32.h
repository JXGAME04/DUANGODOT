...
#define KWin32_H 
	...
	#endif
	#ifndef _WINSOCKAPI_	// unless winsock.h (v1) already came in through an earlier windows.h
		#include <winsock2.h>	// ahead of windows.h so the two winsock headers never both get included
	#endif
	#include <windows.h>
