...
#define	WND_INIT_WIDTH		948
#define	WND_INIT_HEIGHT		640
...
public:
	...
	void		ShortUpdateScreen(LPDIRECTDRAWSURFACE pSurface, RECT* pDestRect, RECT* pSrcRect);
public:
...
inline void KDirectDraw::ShortUpdateScreen(LPDIRECTDRAWSURFACE pSurface, RECT* pDestRect, RECT* pSrcRect)
{
