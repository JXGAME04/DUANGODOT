...
public:
	...
	BOOL		SetString(int nRow, LPSTR szColumn, LPSTR lpRString, DWORD dwSize, BOOL bColumnLab = TRUE);
	BOOL		SetString(int nRow, int nColumn, LPSTR lpRString, DWORD dwSize);
	BOOL		SetString(LPSTR szRow, LPSTR szColumn, LPSTR lpRString, DWORD dwSize);
