...
public:
	...
	static int		GetNpcLevelDataFromScript(KLuaScript * pScript, int nSeries, char * szDataName, int nLevel, char * szParam);
	static int		GetNpcLevelDataFromScript(KLuaScript * pScript, int nSeries, char * szDataName, int nLevel, double nParam1, double nParam2, double nParam3);
