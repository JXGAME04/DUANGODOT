...
extern IServer* g_pTransServer;//guve
extern IServer* g_pChatServer;
extern IServer* g_pTongServer;
extern unsigned int g_nTransID;
extern unsigned int g_nChatID;
extern unsigned int g_nTongID;
#else
