...
enum GAMEDATA_CHANGED_NOTIFY_INDEX
{
	...
	GDCNI_TONG_PAGE_LIST,
	GDCNI_TONG_RECORD_LIST,
	GDCNI_TONG_RECORD_ANNOUNCE,
	GDCNI_TONG_RECORD_WEEKTASK,
	GDCNI_TONG_ACTION_RESULT,       //ket qua den UI
	GDCNI_TONG_CLOSEUI,		//dong UI
	GDCNI_OPEN_TONG_CREATE_SHEET,   //通知界面打开帮会创建界面
	//uParam = ~0 打开    0 关闭
	GDCNI_CONVERT_FACETEXT,
	GDCNI_UI_ACT, //connect to s3client
};
...
enum GAME_TONG_OPERATION_INDEX
{
	...
	GTOI_GETTONGID_NPC, //guve
	GTOI_GETTONG_FIGURE,
	GTOI_GET_WEEKOFFER,
	GTOI_GET_PERSONALOFFER,
	GTOI_GETTONG_RIGHT,
};
