...
int	g_nProtocolSize[MAX_PROTOCOL_NUM] = 
{
	...
	-1,										// s2c_scriptaction
	sizeof(CHAT_APPLY_ADD_FRIEND_SYNC),		// s2c_chatapplyaddfriend-empty
	sizeof(CHAT_ADD_FRIEND_SYNC),			// s2c_chataddfriend-empty
