...
void KNpcTemplate::InitNpcLevelData(KTabFile * pKindFile, int nNpcTemplateId, KLuaScript * pLevelScript, int nLevel)
{
	...
	pLevelScript->SafeCallBegin(&nTopIndex);
	{
		...
		if (szValue1[0] && szValue2[0])
			m_SkillList.SetNpcSkill(1, SkillString2Id(szValue1), GetNpcLevelDataFromScript(pLevelScript, m_Series, "Level1", nLevel, szValue2));
		...
		if (szValue1[0] && szValue2[0])
			m_SkillList.SetNpcSkill(2, SkillString2Id(szValue1), GetNpcLevelDataFromScript(pLevelScript, m_Series, "Level2", nLevel, szValue2));
		...
		if (szValue1[0] && szValue2[0])
			m_SkillList.SetNpcSkill(3, SkillString2Id(szValue1), GetNpcLevelDataFromScript(pLevelScript, m_Series, "Level3", nLevel, szValue2));
		...
		if (szValue1[0] && szValue2[0])
			m_SkillList.SetNpcSkill(4, SkillString2Id(szValue1), GetNpcLevelDataFromScript(pLevelScript, m_Series, "Level4", nLevel, szValue2));
		...
		m_Experience = (double)nParam * GetNpcLevelDataFromScript(pLevelScript, m_Series, "Exp", nLevel, nParam1, nParam2, nParam3) / 100.0;
		...
		m_LifeMax = (double)nParam *  GetNpcLevelDataFromScript(pLevelScript, m_Series, "Life", nLevel, nParam1, nParam2, nParam3) / 100.0;
		if (m_LifeMax == 0) m_LifeMax = 100;
		

		g_NpcSetting.GetString(nNpcTempRow, "LifeReplenish", "", szValue1, MAX_VALUE_LEN);
		m_LifeReplenish = GetNpcLevelDataFromScript(pLevelScript, m_Series, "LifeReplenish", nLevel, szValue1);
		...
		m_AttackRating = (double)nParam * GetNpcLevelDataFromScript(pLevelScript, m_Series, "AR", nLevel, nParam1, nParam2, nParam3) / 100;
		...
		m_Defend = (double)nParam *GetNpcLevelDataFromScript(pLevelScript, m_Series, "Defense", nLevel, nParam1, nParam2, nParam3) / 100;
		...
		m_PhysicsDamage.nValue[0] = (double)nParam * GetNpcLevelDataFromScript(pLevelScript, m_Series, "MinDamage", nLevel, nParam1, nParam2, nParam3) / 100;
		...
		m_PhysicsDamage.nValue[2] = (double)nParam * GetNpcLevelDataFromScript(pLevelScript, m_Series, "MaxDamage", nLevel, nParam1, nParam2, nParam3) / 100;

		
		g_NpcSetting.GetString(nNpcTempRow, "RedLum", "", szValue1, MAX_VALUE_LEN);
		m_RedLum = GetNpcLevelDataFromScript(pLevelScript, m_Series, "RedLum", nLevel, szValue1);
		
		g_NpcSetting.GetString(nNpcTempRow, "GreenLum", "", szValue1, MAX_VALUE_LEN);
		m_GreenLum = GetNpcLevelDataFromScript(pLevelScript, m_Series, "GreenLum", nLevel, szValue1);
		
		g_NpcSetting.GetString(nNpcTempRow, "BlueLum", "", szValue1, MAX_VALUE_LEN);
		m_BlueLum = GetNpcLevelDataFromScript(pLevelScript, m_Series, "BlueLum", nLevel, szValue1);
		
	
		g_NpcSetting.GetString(nNpcTempRow, "FireResist", "", szValue1, MAX_VALUE_LEN);
		m_FireResist = GetNpcLevelDataFromScript(pLevelScript, m_Series, "FireResist", nLevel, szValue1);

		g_NpcSetting.GetString(nNpcTempRow, "ColdResist", "", szValue1, MAX_VALUE_LEN);
		m_ColdResist = GetNpcLevelDataFromScript(pLevelScript, m_Series, "ColdResist", nLevel, szValue1);

		g_NpcSetting.GetString(nNpcTempRow, "LightResist", "", szValue1, MAX_VALUE_LEN);
		m_LightResist = GetNpcLevelDataFromScript(pLevelScript, m_Series, "LightResist", nLevel, szValue1);
		
		g_NpcSetting.GetString(nNpcTempRow, "PoisonResist", "", szValue1, MAX_VALUE_LEN);
		m_PoisonResist = GetNpcLevelDataFromScript(pLevelScript, m_Series, "PoisonResist", nLevel, szValue1);

		g_NpcSetting.GetString(nNpcTempRow, "PhysicsResist", "", szValue1, MAX_VALUE_LEN);
		m_PhysicsResist = GetNpcLevelDataFromScript(pLevelScript, m_Series, "PhysicsResist", nLevel, szValue1);
/*
#ifndef _SERVER
		int nParam1 = 0;
		int nParam2 = 0;
		...
		m_LifeMax = nParam *  GetNpcLevelDataFromScript(pLevelScript, m_Series, "Life", nLevel, nParam1, nParam2, nParam3) / 100;
		if (m_LifeMax == 0) m_LifeMax = 100;
#endif*/
	}
...
int KNpcTemplate::GetNpcLevelDataFromScript(KLuaScript * pScript, int nSeries, char * szDataName, int nLevel, char * szParam)
{
	int nTopIndex = 0;
	int nReturn = 0;
...
int KNpcTemplate::GetNpcLevelDataFromScript(KLuaScript * pScript, int nSeries, char * szDataName, int nLevel, double nParam1, double nParam2, double nParam3)
{
	int nTopIndex = 0;
	int nReturn = 0;
	pScript->SafeCallBegin(&nTopIndex);
