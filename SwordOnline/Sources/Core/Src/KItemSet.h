...
public:
	int				m_nItemAbradeRate[enumAbradeNum][itempart_horse];
...
public:
	...
	int				Add(KItem* pItem);
	int				Add(IN int nItemGenre, IN int nSeries, IN int nLevel, IN int nLuck, IN int nDetail = -1, IN int nParticular = -1, IN int* pnMagicLevel = NULL);
