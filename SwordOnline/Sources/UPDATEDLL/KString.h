...
// shlwapi.h (pulled in by current MFC headers) turns these names into macros for the
// Win32 lstr*/Str*A API; this header supplies its own inline versions instead.
#undef StrCat
#undef StrChr
#undef StrCmp
#undef StrCmpN
...
#if _MSC_VER < 1300
// VC6-only: replace the CRT string/memory routines with the asm versions above.
// Later compilers treat several of these as intrinsics / const-overloaded and reject
// the redefinition; their own CRT implementations are used instead.
extern "C"{
