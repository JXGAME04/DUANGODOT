...
struct V3DRUnit : public KRepresentUnit
{
    char szMesh[128];
    char szMat[128];
    char szAni[128];
	unsigned int uImage_msh;
	unsigned int uImage_mtl;
	unsigned int uImage_ani;
	float fAniFract;
	float fScaleRate;
	float fRotYRad;
	int nAniAct;
	short nISPosition_msh;
	short nISPosition_mtl;
	short nISPosition_ani;
	unsigned char bDropShadow;
	V3DRUnit()
	{
		szMesh[0] = 0;
		szMat[0] = 0;
